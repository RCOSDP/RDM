...
| rdm:Message             | schema:Message                   |
| rdm:Preprint            | schema:ScholarlyArticle          |
| rdm:Report              | schema:Report                    |
| rdm:Review              | schema:Review                    |
| rdm:Role                | schema:Role                      |
...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------ |
| Person      | object of property _creator\_\_, *contributor*_, _rightsHolder_\*                                                              |
| Institution | object of property _affiliation_, _holdingAgent_, _publisher_, _creator\_\_, *contributor*_, _rightsHolder_\*, _degreeGrantor_ |
