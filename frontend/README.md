...
- [JSON-LD](https://github.com/RCOSDP/RDM/main/example/example_research_data.json)
- [turtle](https://github.com/RCOSDP/RDM/main/example/example_research_data.ttl)
...
| definition@ja | Resource, SoftwareApplication をデプロイする行動     |
| subClassOf    | rdm:Activity                                         |
...
| definition@ja | DMP におけるデータ管理機関・管理者への連絡先                                                        |
...
| definition@ja | アプリケーションがサポートされている OS                  |
...
| domain        | rdm:DataManagementPlan                                                  |
| definition@ja | DMP で記述した研究データのフォーマット                                  |
...
| domain        | rdm:DataManagementPlan                                                   |
| definition@ja | DMP におけるデータへのアクセス権                                         |
...
| definition@ja | リソースをメンバーとして含む Collection                              |
...
| domain        | rdm:DataManagementPlan                                                   |
| range         | rdm:Person                                                               |
| definition@ja | DMP における研究データの作成者                                           |
...
| domain        | rdm:DataManagementPlan                                                        |
| range         | rdm:Person                                                                    |
| definition@ja | DMP における研究データ管理者                                                  |
...
| range         | rdm:Institution                                                                                                |
| definition@ja | (Project に属する)Resource の管理機関、もしくは DMP における研究データ管理機関                                 |
...
| definition@ja | 国際 DOI 財団など、識別子の管理者                                          |
...
| definition@ja | DMP で対象になっているリソース              |
...
| domain        | rdm:DataManagementPlan                                                   |
| definition@ja | DMP におけるデータのライセンス                                           |
